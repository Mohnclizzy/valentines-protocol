...
export default function PicnicSweetTreatsPage() {
        ...
        <main className="flex min-h-screen flex-col items-center justify-center bg-black text-white mt-80">
          ...
          >
            ...
            <p className="text-2xl text-gray-200">
              I can't wait to go on a picnic with you. Come visit me when the timer hits 0, Kaylee.
            </p>
            <button
              onClick={() => router.push("/")}
        ...
        <div className="flex-1 flex items-center justify-center">
          ...
          >
            ...
            <p className="text-lg text-gray-300">
              Any sweet treats or desserts you'd like for the picnic?
            </p>
